...
export interface ReactOutputTargetOptions {
  ...
  /**
   * A function that allows to alias the event names.
   *
  ...
  /**
   * The suffix to be added to the component tag names.
   */
...
export const reactOutputTarget = ({
  ...
  return {
    ...
    async generator(config, compilerCtx, buildCtx: BuildCtx) {
      ...
      const { tagNameTransform } = config.extras || {};
