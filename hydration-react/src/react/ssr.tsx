import type { EventName, ReactWebComponent, WebComponentProps } from './lib/create-component';
import React, { type Component, type JSXElementConstructor, type ReactNode } from 'react';
...
export const createComponentForServerSideRendering = <I extends HTMLElement, E extends EventNames = {}>(
  ...
  (async ({ children, ...props }: StencilProps<I> = {}) => {
    /**
              ...
              <CustomTag {...props} suppressHydrationWarning>
                <template
                  ...
                  dangerouslySetInnerHTML={{
                    __html: hydrationComment + templateContent,
                  }}
                />
                {children}
              </CustomTag>
